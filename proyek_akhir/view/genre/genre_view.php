...
<head>
    ...
    <style>
        ...
        .fan-section:nth-child(even) h2 {
            color: white;
        }
        .fan-section:nth-child(even) .subtitle {
            color: #cececeff;
        }
        .fan-section h2 {
            font-size: 28px;
        ...
        .fan-section:nth-child(even) .fan-container::-webkit-scrollbar-track {
            background: #626d83ff;
            border-radius: 10px;
        }
        .fan-section:nth-child(even) .fan-container::-webkit-scrollbar-thumb {
            background: #e0e5f0;
            border-radius: 10px;
        }
        .fan-section:nth-child(even) .fan-container::-webkit-scrollbar-thumb:hover {
            background: #e0e5f0;
        }
...
<body>
    ...
    <div class="navbar">
        ...
        <div class="nav-links">
            ...
            <a class="btn-popular nav-item" href="../controller/genre_controller.php">Popularity</a>
    ...
    <div class="page-header">
        ...
        <p>Explore movies from different genres - Action, Comedy,<?php if (isset($_SESSION['id_origin']) && $_SESSION['id_origin'] === 2): ?> and<?php endif; ?> Drama<?php if (isset($_SESSION['id_origin']) && $_SESSION['id_origin'] != 2): ?>, Horror, and Romance<?php endif; ?></p>
    </div>
    ...
    <?php foreach($data as $genre_data): ?>
        ...
        <div class="fan-section">
            ...
            <button class="arrow-btn left scroll-left">
                ❮
            </button>
            <button class="arrow-btn right scroll-right">
                ❯
            </button>
        </div>
        <?php endif; ?>
...
<script>
    ...
    document.querySelectorAll(".fan-section").forEach(section => {
        const container = section.querySelector(".fan-container");
