...
<body>
    ...
    <div class="navbar">
        ...
        <div class="nav-links">
            ...
            <?php endif; ?>
            <a class="btn-master nav-item" href="../controller/wathclist_controller.php"><i class="bi bi-bookmark-plus"></i> Watchlist</a>
    ...
    <div class="fan-section">
        <div class="section-header">
            <div class="line"></div>
            <h2> My Watchlist</h2>
            <a class="add-btn" href="tambahWatchlist_controller.php">Add Wathlist</a>
        </div>
        <p class="subtitle">Movies you saved</p>
        ...
        <div class="fan-container">
            ...
            <div class="fan-card">
                ...
                <div class="fan-info">
                    ...
                    <a class="btn-watchlist" href="watchlist_controller.php?action=delete&id_film=<?php echo $row['id_film']; ?>"
                    onclick="return confirm('Yakin ingin menghapus film dari watchlist?')">Delete Watchlist</a>
